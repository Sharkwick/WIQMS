...
describe('JobHistory e2e test', () => {
  ...
  describe('new JobHistory page', () => {
    ...
    it('should create an instance of JobHistory', () => {
      cy.get(`[data-cy="startDate"]`).type('2023-03-12T18:40').blur().should('have.value', '2023-03-12T18:40');

      cy.get(`[data-cy="endDate"]`).type('2023-03-12T01:37').blur().should('have.value', '2023-03-12T01:37');
